...
<body class="bg-image" style="background-size: 200vh; background-image:url('https://slidechef.net/wp-content/uploads/2021/11/Real-Classroom-Background.jpg');">
    ...
    <div class="container-fluid py-5">
        <div class="container-fluid bg-3 text-center">
            <a href="std-form.php" class="btn btn-info pull-right" style='margin-top:-10px; margin-right:10px;'>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr align="center">
                                    ...
                                    <td>
                                        <form method="post">
                                            <a href="student-edit.php?id=<?php echo $query['id']; ?>" class="btn btn-success mt-3 mx-3" style="border-radius: 10px;"><i class="fas fa-edit" style="font-size: 20px;"></i></a>
